      ...
      <main className="w-full max-w-3xl bg-white rounded-2xl shadow-md overflow-hidden flex flex-col md:flex-row border border-gray-100">
        ...
        <div className="relative w-full md:w-[42%] hidden md:block">
          ...
          <div className="absolute inset-0 p-6 flex flex-col justify-between text-white z-10">
            ...
            <div className="flex items-center space-x-2 border-t border-white/20 pt-4">
              ...
              <span className="text-[11px] font-medium text-white/90">Verified Merchant Security Protocol</span>
            </div>
          </div>
        </div>

        {/* RIGHT SIDE: Interactive Compact Form */}
        <div className="w-full md:w-[58%] p-5 md:p-8 flex flex-col justify-center">
          ...
          <div className="mb-4">
            ...
            <p className="text-xs text-gray-500">Please enter your credentials to access your portal.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3 flex flex-col">
            ...
            {/* Email Field */}
            <div>
              <label htmlFor="login-email" className="block text-[10px] font-bold uppercase tracking-wider text-gray-500 mb-1 ml-0.5">
                Email Address
              </label>
              <input
                id="login-email"
            ...
            {/* Password Field */}
            <div>
              <label htmlFor="login-password" className="block text-[10px] font-bold uppercase tracking-wider text-gray-500 mb-1 ml-0.5">
                Password
              </label>
            ...
            <div className="flex items-center justify-between pt-0.5">
              <label className="flex items-center gap-1.5 cursor-pointer select-none">
                ...
                />
                <span className="text-[11px] text-gray-500">Remember device</span>
              </label>
              <Link
          ...
          <div className="mt-5 text-center">
            <p className="text-xs text-gray-500">
              ...
              <Link href="/signup" className="text-[#1db954] hover:underline font-bold ml-0.5">
                Sign Up
              </Link>
            </p>
          </div>
